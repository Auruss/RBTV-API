module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        typescript: {
            coreonly: {
                src: ["typings.d.ts", "src/**/*.ts", "!src/jobs/*.ts"],
                dest: "dev/",
                options: {
                    module: "commonjs",
                    target: "es5",
            ...
            showCrawler: {
                src: ["src/jobs/showinfo_webcrawler.ts"],
                dest: "dev/",
                options: {
                    module: "amd",
                    target: "es5",
            ...
            appapi: {
                src: ["src/jobs/sendeplan_appapi.ts"],
                dest: "dev/",
                options: {
                    module: "commonjs",
                    target: "es5",
        ...
        nodemon: {
            dev: {
                ...
                options: {
                    nodeArgs: ['--debug-brk'],
                    ignore: ['asset_src/**/*.js', 'assets/**/*.js', 'dev/src/controller/admin/*.js', 'src/**/*.*']
                }
            },
            devRun: {
                script: 'dev/src/start.js',
                options: {
                    nodeArgs: ['--debug'],
                    ignore: ['asset_src/**/*.js', 'assets/**/*.js', 'dev/src/controller/admin/*.js', 'dev/src/jobs/*.js']
                }
            },
            doc: {
        ...
        watch: {
            scripts: {
                ...
                tasks: ["typescript:coreonly", "typescript:showCrawler"], // the task to run
                options: {
